...
from dream_team_app import create_app, db
from dream_team_app.models import Employee, Department, Role
...
class TestBase(TestCase):
    ...
    def create_app(self):
        ...
        app.config.update(
            SQLALCHEMY_DATABASE_URI='mysql+pymysql://root:@localhost:3306/python_dream_team_test?charset=utf8'
        )
        return app
